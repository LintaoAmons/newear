"""Remote Whisper transcription server implementation."""
...
class RemoteWhisperServer:
    ...
    def __init__(self, model_size: str = "base", device: str = "cpu", compute_type: str = "float16"):
...
def create_server_app(server: RemoteWhisperServer) -> FastAPI:
    """Create FastAPI application with server instance."""
    
    app = FastAPI(
        title="Newear Remote Whisper Server",
        description="GPU-accelerated Whisper transcription server",
        version="1.0.0"
    )
